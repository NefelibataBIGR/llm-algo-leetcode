...
核心项目为 [60 LoRA 微调](../../02_PyTorch_Algorithms/60_LoRA_Fine_Tuning_Project.md)、[62 指令微调](../../02_PyTorch_Algorithms/62_Instruction_Fine_Tuning_Project.md) 和 [63 LoRA 变体对比](../../02_PyTorch_Algorithms/63_LoRA_Variants_Benchmark.md)；扩展项目包括 [64 数据质量](../../02_PyTorch_Algorithms/64_SFT_Data_Quality_Project.md) 和 [65 QLoRA 选型](../../02_PyTorch_Algorithms/65_QLoRA_Selection_Project.md)。
