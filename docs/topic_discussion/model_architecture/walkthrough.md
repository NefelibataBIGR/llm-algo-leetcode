...
- 技术怎么演化：从基础 norm / attention / MLP，到 MoE，再到工程里的局部 trick，是同一条结构线上不同层级的取舍。
...
- 它也负责把 `tokenization_embedding.md`、`norm_evolution.md`、`attention_evolution.md`、`rope_position_encoding.md` 串起来读
