...
- 想看模块演进，请去单页：`tokenization_embedding.md`、`norm_evolution.md`、`attention_evolution.md`、`rope_position_encoding.md`
- 想看 block 结构和 `01-08` 的映射，继续留在这一页
...
- 你能不能区分 `06 / 07` 的 router 和 balance loss 各自解决什么问题。
