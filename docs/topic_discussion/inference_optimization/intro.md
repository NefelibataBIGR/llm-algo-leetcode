...
| 章节 | 你会看到什么 | 跳转 |
|:---|:---|:---|
| `01` | 请求路径、指标口径和诊断框架 | [01 Request Path and Metrics](./01_request_path_and_metrics.md) |
| `02` | prefill、attention kernel、FlashAttention | [02 Prefill and Attention Kernel](./02_prefill_and_attention_kernel.md) |
| `03` | decoding、speculative、multi-token | [03 Decoding Strategies](./03_decoding_strategies.md) |
| `04` | KV cache、prefix reuse、paging、scheduling | [04 KV Cache and Scheduling](./04_kv_cache_and_scheduling.md) |
| `05` | W8A16、GPTQ/AWQ、FP8、KV cache quant | [05 Quantized Inference and Deployment](./05_quantized_inference_and_deployment.md) |
| `06` | 端到端 benchmark、选型结论 | [06 Benchmark and Decision](./06_benchmark_and_decision.md) |
