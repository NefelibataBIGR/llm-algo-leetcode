...
| Task | 学习内容 | 章节 |
|:---|:---|:---|
| Task1 | 对齐问题与方法谱系入口 | [14 RLHF PPO Memory](../../02_PyTorch_Algorithms/14_RLHF_PPO_Memory.ipynb)、[15 DPO Loss Tutorial](../../02_PyTorch_Algorithms/15_DPO_Loss_Tutorial.ipynb)、[16 GRPO Loss Tutorial](../../02_PyTorch_Algorithms/16_GRPO_Loss_Tutorial.ipynb) |
| Task2 | 偏好数据与评测口径 | [50 Preference Data and Evaluation](../../02_PyTorch_Algorithms/50_Preference_Data_and_Evaluation.ipynb) |
...
| Task5 | 与 SFT / 训练机制主线的联动 | [09 SFT Training Loop](../../02_PyTorch_Algorithms/09_SFT_Training_Loop.ipynb)、[10 LoRA Tutorial](../../02_PyTorch_Algorithms/10_LoRA_Tutorial.ipynb)、[17 Autograd Basics](../../02_PyTorch_Algorithms/17_Autograd_Basics.ipynb)、[19 Activation Checkpointing and Activation Offload](../../02_PyTorch_Algorithms/19_Activation_Checkpointing_and_Activation_Offload.ipynb) |
