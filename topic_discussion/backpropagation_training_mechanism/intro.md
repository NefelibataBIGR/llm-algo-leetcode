...
推荐按下面的 `01-06` 顺序阅读。原先的十个拆分视角，已经合并成更厚的五个机制页，再加一个图册收口页：
...
- `Visual Assets` 负责把专题里的关键图统一收口，方便快速复盘。
...
- [06. Visual Assets](./06_visual_assets.md)：把核心图收口成图册。
...
- [06. Visual Assets](./06_visual_assets.md)
...
当前为专题入口页。`01-05 + 06` 已完成第一版收口，后续如需扩展只在正文细节和图册上微调，不再增加主编号。
